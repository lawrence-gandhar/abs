...
urlpatterns += [    
    ...
    path('staff/delete_religion/<int:ins>/', never_cache(site_management.delete_religion), name="delete_religion"),
    ...
    path('get_states_dropdown/', never_cache(site_management.get_states_dropdown), name="get_states_dropdown"),
    path('get_cities_dropdown/', never_cache(site_management.get_cities_dropdown), name="get_cities_dropdown"),
